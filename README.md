...
- 🕶 **匿名捐赠**：名称留空自动匿名，或后台勾选匿名；排行榜显示为「匿名」，且**不会**与其他记录（包括同名记录）合并
...
- **匿名捐赠**：捐赠者名称留空将自动按匿名录入；也可勾选「匿名捐赠」并填写名字作后台参考。公开排行榜一律显示为「匿名」，且**不会**与任何其他记录合并（哪怕填了名字），但金额仍计入首页顶部的累计总金额
...
- 「匿名捐赠」只隐藏**公开排行榜**上的名字；名称留空即自动匿名，若勾选匿名并填写名字则仅供后台核对账目，排行榜一律显示「匿名」
