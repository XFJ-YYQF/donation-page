...
- 🕶 **匿名捐赠**：后台勾选后排行榜显示为「匿名支持者」，且**不会**与其他记录（包括同名记录）合并
...
- **匿名捐赠**：勾选「匿名捐赠」后，捐赠者名称变为可选（仅后台参考）；公开排行榜一律显示为「匿名支持者」，且**不会**与任何其他记录合并（哪怕填了名字），但金额仍计入首页顶部的累计总金额
...
- 「匿名捐赠」只隐藏**公开排行榜**上的名字；名称字段变为可选，若填写则仅供后台核对账目，排行榜不会展示
